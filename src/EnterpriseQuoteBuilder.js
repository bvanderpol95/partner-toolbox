...
<button
  className="w-full bg-blue-600 text-white py-3 rounded mt-6 hover:bg-blue-700 transition duration-200"
  title="This feature is coming soon!" onClick={generatePDF}
>
  Download Quote (Coming Soon)
</button>
